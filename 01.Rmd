...
![](https://photos.app.goo.gl/SzWfvTXbA7G1NtbH7)

[```{r insta-video, fig.cap= "I need to cry more often...", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
knitr::include_graphics("images/2020/Carlota/video.jpg")
```](https://photos.app.goo.gl/SzWfvTXbA7G1NtbH7)

https://www.instagram.com/p/B8_M7WiB4SV/
