...
```{r narciso, fig.cap= "00.54... Click [here]( https://ast.wikipedia.org/wiki/Narcissus) to know more than me about what I talk.", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
